...
#ifndef WEBSERVER_BASE_ASYNCLOGGING_H
#define WEBSERVER_BASE_ASYNCLOGGING_H
...
namespace lfp
{
	...
	{
	public:
		AsyncLogging(const std::string& basename = std::string(),
...
#endif //end of WEBSERVER_BASE_ASYNCLOGGING_H